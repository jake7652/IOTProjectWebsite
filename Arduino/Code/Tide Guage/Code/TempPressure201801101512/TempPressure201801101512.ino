...
DS3231 RTClock;
#define RTCReadModeTimeA 0 //No Counter in Tenths of Second
#define RTCReadModeTimeB 1 //Counter in Tenths of Second
#define RTCReadModeTimeC 2 //No Counter in Tenths of Second format for DATETIME Data type
#define RTCReadModeTemperature 3
String RTCStringDateTime = "";
String RTCSYear, RTCSMonth, RTCSDay, RTCSDOW, RTCSHour, RTCSMinute, RTCSSecond, RTCSTemperature, RTCSIncrement;
static byte RTCIncrement=0;
      ...
      case RTCReadModeTimeA:
       ...
       case RTCReadModeTimeB:
        ...
        RTCHour=RTClock.getHour(h12, PM);
          ...
          //Loop 1 - 5 Incrementer
          if (RTCIncrement >5){RTCIncrement=0;}  
          RTCSIncrement=String(RTCIncrement++);
         return (RTCSYear + RTCSMonth + RTCSDay + RTCSHour + RTCSMinute + RTCSSecond+ RTCSIncrement);

       case RTCReadModeTimeC:
        RTClock.getTime(RTCYear, RTCMonth, RTCDay, RTCDOW, RTCHour, RTCMinute, RTCSecond);
        //***************************************************************************************
        // Temporary Fix Need to Fix Library
        // **************************************************************************************
...
void ReadSensor1 (){
    ...
    //RTC 
    RTCStringDateTime=(RTCRead(RTCReadModeTimeB));
...
{// Build Data Packet Start
        ...
        Seperator + RTCRead(RTCReadModeTimeB) + 
